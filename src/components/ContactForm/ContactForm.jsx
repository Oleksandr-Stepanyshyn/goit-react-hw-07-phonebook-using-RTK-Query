...
const schema = yup.object().shape({
  name: yup.string().matches(validateValue.name.pattern, {message: validateValue.name.message}).required(),
  number: yup.string().matches(validateValue.number.pattern, {message: validateValue.number.message}).required(),
})
